    ...
    <div class="col-12">
     ...
     <td >
      ...
      <td>
        ...
        <a href="{{ route('admin.stores.edit',$info->id) }}" class="btn btn-sm  btn-primary">تعديل</a><br>
        <a href="{{ route('admin.stores.delete',$info->id) }}" class="btn btn-sm   btn-danger are_you_sure" style="margin-top: 3px">حذف</a>
