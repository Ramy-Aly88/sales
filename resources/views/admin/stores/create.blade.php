...
<input name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="ادخل اسم المخزن" >
@error('name')
...
<div class="form-group">
  ...
  <input name="phones" id="phones" class="form-control" value="{{ old('phones') }}" placeholder="ادخل هاتف المخزن" >
  @error('phones')
  <span class="text-danger">{{ $message }}</span>
  @enderror
</div>
  <div class="form-group">
    ...
    <input name="address" id="address" class="form-control" value="{{ old('address') }}" placeholder="ادخل عنوان المخزن" >
    @error('address')
    <span class="text-danger">{{ $message }}</span>
    @enderror
  </div>
