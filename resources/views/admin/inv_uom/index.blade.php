                                ...
                                @foreach ($data as $info )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.uoms.edit',$info->id) }}" class="btn btn-sm  btn-primary">تعديل</a><br>
                                            <a href="{{ route('admin.uoms.delete',$info->id) }}" class="btn btn-sm   btn-danger are_you_sure" style="margin-top: 3px">حذف</a>
